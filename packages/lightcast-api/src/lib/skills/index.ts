...
export default (client: RestClient) => ({
   ...
   */
  versions: <R = unknown>() => client.get<void, R>(RestClient.makeUrl(baseUrl, "versions")),
  ...
  version: (version = "latest") => ({
     ...
     */
    meta: <R = unknown>() => client.get<void, R>(RestClient.makeUrl(baseUrl, `versions/${version}`)),
     ...
     */
    byId: <R = unknown>(id: string) =>
      client.get<void, R>(RestClient.makeUrl(baseUrl, `versions/${version}/skills/${id}`)),
    ...
    listAll: <R = unknown>(params?: { q?: string; limit?: number; typeIds?: string; fields?: string }) =>
      client.get<typeof params, R>(RestClient.makeUrl(baseUrl, `/versions/${version}/skills`), {
    ...
    listRequested: <R = unknown>(body: { ids: string[] }, params?: { typeIds?: string; fields?: string }) =>
      client.post<typeof params, typeof body, R>(RestClient.makeUrl(baseUrl, `versions/${version}/skills`), body, {
        queryParameters: { params },
      }),
    ...
    findRelated: <R = unknown>(body: { ids: string[]; limit?: number; typeIds?: string; fields?: string }) =>
      client.post<void, typeof body, R>(RestClient.makeUrl(baseUrl, `versions/${version}/skills`), body),
    ...
    extract: <R = unknown>(
      ...
      client.post<typeof params, typeof body, R>(RestClient.makeUrl(baseUrl, `versions/${version}/extract`), body, {
        queryParameters: { params },
      }),
  }),
});
